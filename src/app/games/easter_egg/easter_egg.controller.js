(function() {
  ...
  angular.module('material')
    .controller('EasterEggController', EasterEggController);

  EasterEggController.$inject = ['$scope', '$state', '$translate', '$stateParams', '$mdDialog', 'UserLocalStorage', 'translateService', 'usersApi'];

  function EasterEggController($scope, $state, $translate, $stateParams, $mdDialog, UserLocalStorage, translateService, usersApi) {
    ...
    var state = {
      preload: function()
      {
        this.load.spritesheet("player", 'assets/images/easter_egg/android-chrome-48x48.png', 48, 48);
        this.load.image("wall", "assets/images/easter_egg/ball.png");
        this.load.image("background", "assets/images/easter_egg/bg.jpg");
      },
      create: function()
      {
